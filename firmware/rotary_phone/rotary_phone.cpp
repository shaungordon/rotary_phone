...
// PIN DEFINITIONS
// ============================================================================
#define PIN_PULSE     1   // D0 - Pulses HIGH for each digit
#define PIN_IN_USE    2   // D1 - LOW when dialing
#define PIN_HOOK      3   // D2 - LOW when receiver off hook
#define PIN_MIC_ADC   6   // A5 - Carbon mic analog input (for VAD)

#define PIN_I2S_DOUT  7  // D8
#define PIN_I2S_BCLK  8  // D9
#define PIN_I2S_LRC   9  // D10
